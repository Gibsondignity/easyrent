...
export const Sidenav = () => {
  ...
  return (
    <>
      ...
      />
      <div
        className={`fixed w-80 z-50 translate-x-0 bg-green-600 h-full ${
          open ? "translate-x-0" : "-translate-x-full"
      ...
      >
        <div className="flex space-x-3 items-center justify-center p-10">
          ...
          <Link href={"/"}>
            <a>
              <span className="text-2xl text-gray-50">Hello, </span>
              <span className="text-2xl text-yellow-500">Gibson</span>
            </a>
          </Link>
        </div>
